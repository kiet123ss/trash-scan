...
const LERP_FACTOR = 0.2; // Tốc độ làm mượt (0.1 = chậm, 1.0 = tức thì)
const TRACK_TIMEOUT = 500; // Xóa track nếu không thấy sau 500ms
...
function startTracking() {
  ...
  trackingInterval = setInterval(async () => {
    ...
    const dataUrl = tempCanvas.toDataURL("image/jpeg", 0.3);
